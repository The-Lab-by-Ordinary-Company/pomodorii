...
export const metadata: Metadata = {
  ...
  description: "Pomodorii is the most delightful pomodoro timer on the internet. Designed to look like a retro console, custom sounds, and available in 4 languages, this is the only pomodoro timer you need.",
  openGraph: {
    title: "Pomodorii Timer",
    description: "Pomodorii is the most delightful pomodoro timer on the internet. Designed to look like a retro console, custom sounds, and available in 4 languages, this is the only pomodoro timer you need.",
    url: "https://pomodorii.com",
    siteName: "Pomodorii",
    images: [
      {
        url: "/Thumbnail.png",
